...
- [2. Why the Pico?](#2-why-the-pico)
- [3. Arduino framework shortcomings](#3-arduino-framework-shortcomings)
- [4. Introducing Rust and RTIC](#4-introducing-rust-and-rtic)
...
- [9. Final Verdict](#9-final-verdict)
  - [9.1. Is there a noticeable performance difference with the Rust version?](#91-is-there-a-noticeable-performance-difference-with-the-rust-version)
  - [9.2. So if there isn't a performance gain, is Rust still worth it?](#92-so-if-there-isnt-a-performance-gain-is-rust-still-worth-it)
  - [9.3. Learning Materials](#93-learning-materials)
...
# 3. Arduino framework shortcomings
...
## 9.1. Is there a noticeable performance difference with the Rust version?
...
## 9.2. So if there isn't a performance gain, is Rust still worth it?
...
This project is licensed under the MIT license or Apache 2.0 license at the user's disgression.
